...
<style>
  ...
  header {
    ...
    font-size: calc(var(--text-xs) * var(--size-app)); color: var(--text-2); padding: 10px 8px 0 16px; min-width: 0;
  }
  ...
  footer { margin-top: 10px; font-size: calc(var(--text-xs) * var(--size-app)); color: var(--text-3); }
  .repeat {
  ...
  .card.compact footer { grid-column: 1; margin-top: 4px; font-size: calc(var(--text-xs) * var(--size-app)); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
