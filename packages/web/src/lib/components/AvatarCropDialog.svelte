...
<style>
  ...
  h2 { font-size: calc(19px * var(--size-app)); margin: 0 0 6px; }
  .help { margin: 0 0 14px; font-size: calc(13px * var(--size-app)); color: var(--text-3); line-height: 1.4; }
  ...
  .status { position: absolute; inset: 0; display: grid; place-items: center; margin: 0; color: var(--text-3); font-size: calc(14px * var(--size-app)); padding: 0 16px; text-align: center; }
  .zoom { display: flex; align-items: center; gap: 12px; margin: 14px 0 4px; font-size: calc(13px * var(--size-app)); font-weight: 600; color: var(--text-2); }
  .zoom input { flex: 1; accent-color: var(--accent); }
  .row { display: flex; justify-content: flex-end; gap: 10px; margin-top: 14px; }
  button { padding: 10px 16px; border-radius: 999px; border: 1px solid var(--line); font-weight: 600; font-size: calc(14px * var(--size-app)); }
