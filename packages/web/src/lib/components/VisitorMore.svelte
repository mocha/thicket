...
<style>
  .more { margin: 4px 0 0; padding: 14px 16px; border-radius: 12px; background: var(--surface-2); color: var(--text-2); font-size: calc(var(--text-sm) * var(--size-app)); text-align: center; }
