...
<style>
  ...
  .count { font-size: calc(var(--text-xs) * var(--size-app)); color: var(--text-3); transition: color 300ms; }
  ...
  .hint { margin: 6px 0 0; font-size: calc(var(--text-xs) * var(--size-app)); color: var(--text-3); }
