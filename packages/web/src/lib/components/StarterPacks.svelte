...
<style>
  .packs { margin: 0; }
  h2 { font-family: var(--font-headings); font-size: 22px; margin: 0 0 4px; }
  .lede { margin: 0 0 16px; color: var(--text-2); font-size: 15px; max-width: 60ch; }
  ...
  .meta { color: var(--text-3); font-size: 13px; margin-top: 2px; }
  .desc { color: var(--text-2); font-size: 14px; margin-top: 7px; }
  .take { margin-top: 8px; padding: 9px 12px; border-radius: 10px; border: 1px solid var(--line); background: var(--surface); color: var(--accent); font-weight: 600; font-size: 14px; }
  .take:hover:not(:disabled) { border-color: var(--accent); }
  .take:disabled { opacity: 0.55; color: var(--text-3); }
  .from { margin: 14px 0 0; color: var(--text-3); font-size: 13.5px; line-height: 1.5; max-width: 62ch; }
